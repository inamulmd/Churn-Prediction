...
## streamlit app
st.title('custome Churn Prediction')
...
is_active_number = st.selectbox('is Acive Member',[0,1])
...
## Cpmbine onehot encoded columns with input data
